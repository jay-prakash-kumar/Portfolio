...
export default function Achievements() {
  const achievements = [
    ...
    { 
      title: 'Competitive Coding Codechef', 
      year: 'Since 2024',
      desc: 'Recognized internally as the top performing developer for consistently delivering high-quality, scalable monolithic to microservices migrations.', 
